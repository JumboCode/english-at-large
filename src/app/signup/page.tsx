        ...
        <form onSubmit={handleSignUpClick} className="group">
          ...
          <label
            ...
            <input
              ...
              id="password"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              required
            ...
            >
              <InfoIcon name={isPasswordVisible ? "eye-off" : "eye"} />
            </span>
          </div>
          <div className="mb-6 relative">
            <label
            ...
            >
              <InfoIcon name={isConfirmPasswordVisible ? "eye-off" : "eye"} />
            </span>
          </div>
          <button
            type="submit"
